...
C++ shapes library can be found in ShapesLib.cpp
Shapes.py can not be executed because I couldn't import the C++ library. I never used mixed C++ and python, so I chose to be honest.